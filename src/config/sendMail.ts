  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <a href=https://localhost:3000/${url} style="background: crimson; text-decoration: none; color: white; padding: 10px 20px; margin: 10px 0; display: inline-block;">${txt}</a>
